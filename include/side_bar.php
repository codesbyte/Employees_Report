...
<script>
    function activeTodayTask() {
        $(document).ready(function(){
        $("#tdy_tsk").attr('class','current-page');
        });
    }
</script>
<!-- sidebar menu -->
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li>
                <a href="<?php echo $con->getBaseUrl() . "home.php"; ?>">
            ...
            <li id="nv_active"><a><i class="fa fa-history"></i> Statistics <span class="fa fa-chevron-down"></span></a>
                <ul id="nav_child_menu" class="nav child_menu" style="display: none">
                    ...
                    if($_SESSION['MemberID'] != "1")
                    {
                        ...
                        {
                            echo '<script type="text/javascript">', 'activeNavFunction();', '</script>';
                        }
                        ?>
                    ...
                    if($_SESSION['MemberID'] == "1")
                    {
                        if(basename($_SERVER['PHP_SELF']) == "today_emp_task_list.php")
                        {
                            echo '<script type="text/javascript">', 'activeTodayTask();', '</script>';
                        }
                        ?>
                            <li id="tdy_tsk"><a href="<?php echo $con->getBaseUrl() . "today_emp_task_list.php"; ?>">Today Task</a></li>
