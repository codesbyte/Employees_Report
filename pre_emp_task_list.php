<?php include 'include/global.inc.php'; ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo $con->getBaseUrl() . "task_history.php"; ?>"><img src="<?php echo $con->getBaseUrl() . "assets/images/view.png"; ?>" alt="view" title="view" style="width: 60px;height: 60px;" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>63</td>
                                    <td>2011/07/25</td>
                                    <td><a href="<?php echo $con->getBaseUrl() . "task_history.php"; ?>"><img src="<?php echo $con->getBaseUrl() . "assets/images/view.png"; ?>" alt="view" title="view" style="width: 60px;height: 60px;" /></a></td>
                                </tr>
                                <tr>
                                    <!--<td>Ashton Cox</td>-->
