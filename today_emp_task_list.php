            ...
            ?>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Today Task<small>(<?php echo (!empty($FirstName) ? (!empty($LastName) ? $FirstName.' '.$LastName : $FirstName) : ""); ?>)</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="single-input_2" value="<?php echo (!empty($Outtime) ? $Outtime : ""); ?>" disabled="true" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Designation</th>
                                    <th>ContactNo</th>
                                    <th>View Today Task</th>
                                </tr>
                            </thead>

                            <tbody>
                                <?php
                                $mbrTodayTaskArr = $memberTaskMgr->selectTodayTask(Date('Y-m-d')."%");
                                foreach ($mbrTodayTaskArr as $key => $value) 
                                {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo $con->getBaseUrl()."today_emp_task_list.php?tid=".$TaskID; ?>"><img src="<?php echo $con->getBaseUrl() . "assets/images/view.png"; ?>" alt="view" title="view" style="width: 60px;height: 60px;" /></a>
